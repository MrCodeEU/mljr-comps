        ...
        <CardBody>
            <div class="flex flex-col gap-4">
                ...
                >
                    ...
                    {/snippet}
                    {#snippet description()}
                        This is an example of an informative alert dialog with
                        a primary color scheme.
                    {/snippet}
                </AlertDialog>
                ...
                >
                    ...
                    {/snippet}
                    {#snippet description()}
                        This is an example of an alert dialog without buttons.
