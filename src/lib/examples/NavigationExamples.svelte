<script lang="ts">
    ...
    import { ContextMenu, ContextMenuContent, ContextMenuItem, ContextMenuTrigger, ContextMenuSeparator } from '$lib/contextMenu/index.js';
    import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuSeparator } from '$lib/dropdown-menu/index.js';
...
<Masonry
    colWidth="minmax(Min(30em, 100%), 1fr)"
    gridGap="1.5rem"
    padding="0.5rem"
    reset={true}
>
    ...
    <Card>
        ...
        <CardBody>
            <ContextMenu>
                <ContextMenuTrigger>
                    <div class="flex h-[150px] w-full select-none items-center justify-center rounded-xl clay bg-base-200">
                ...
                <ContextMenuContent variant="accent">
                    <ContextMenuItem icon="mdi:pencil" shortcut="⌘E">
                        Edit
                    </ContextMenuItem>
                    <ContextMenuItem icon="mdi:content-copy" shortcut="⌘C">
                        Copy
                    </ContextMenuItem>
                    <ContextMenuItem icon="mdi:content-cut" shortcut="⌘X">
                        Cut
                    </ContextMenuItem>
                    <ContextMenuSeparator />
                    <ContextMenuItem icon="mdi:trash" shortcut="⌘⌫">
                        Delete
                    </ContextMenuItem>
                    <ContextMenuSeparator />
                    <ContextMenuItem icon="mdi:share" disabled>
                        Share
                    </ContextMenuItem>
                </ContextMenuContent>
            </ContextMenu>
        ...
        <CardBody>
            <div class="flex flex-wrap gap-4">
                ...
                <DropdownMenu variant="info">
                    ...
                    alt="@huntabyte"
                    class="size-10 rounded-full border-2 border-info"
                />
                    {/snippet}
                    <DropdownMenuContent>
                ...
                <DropdownMenu variant="accent" label="Switch Account" icon="mdi:account-switch">
                    <DropdownMenuContent>
                        <div class="mb-2 px-2 py-1.5 text-sm opacity-70">
                            Switch Account
                        </div>
                        <DropdownMenuSeparator />
                        {#each users as user}
                ...
                <!-- Variant Showcase -->
                {#each ["primary", "secondary", "tertiary", "accent", "muted", "error", "success", "warning", "info"] as variant}
